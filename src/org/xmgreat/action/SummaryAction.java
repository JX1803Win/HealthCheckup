...
public class SummaryAction
{
	...
	public String querySummary(HttpServletRequest request,Integer physicaiId, Integer parameterId, Integer currentPage)
	{
		...
		condition.put("physicaiId", physicaiId);
	...
	public String particular(HttpServletRequest request,Integer physicaiId, Integer proresId, Integer parameterId, Integer currentPage)
	{
	...
	public String skipSummary(HttpServletRequest request,Integer physicaiId, Integer proresId, Integer parameterId, Integer currentPage)
	{
		ProjectResultBean projectResultBean = summaryBiz.skipSummary(proresId);
		request.setAttribute("projectResult", projectResultBean);
	...
	public String summary(HttpServletRequest request,Integer physicaiId, Integer proresId, String projectResult, Integer parameterId,
			Integer currentPage, Integer parameter)
	{
		summaryBiz.summary(proresId, projectResult, parameterId);
		return querySummary(request,physicaiId, parameter, currentPage);
	}
}
