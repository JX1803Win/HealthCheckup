...
public interface DoctorMapper {
    	  ...
    	  public List<UserInfoBean> selectMedicalMan(@Param("userName")String userName,@Param("phone")Long phone,@Param("barCode")Long barCode,@Param("starDay")String starDay,@Param("end")String end,@Param("pageNo")Integer pageNo);//查询体检人信息
    	  public String selectAppoTime(@Param("physicaiId")Long physicaiId);//通过体检卡查询用户预约时间
    	  public List<UserInfoBean> selectMedicalManS(@Param("userName")String userName,@Param("phone")Long phone,@Param("barCode")Long barCode,@Param("starDay")String starDay,@Param("end")String end);//查询体检人信息
