	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="<%=basePath%>/images/coin111.png" /> <img
						class="coin22" src="<%=basePath%>/images/coin222.png" /> <a
						href="<%=basePath%>ManageAction/showUser.action?page=${1}" target="main" class="cks">用户管理</a>
					<img class="icon5" src="<%=basePath%>/images/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="<%=basePath%>/images/coin111.png" /> <img
						class="coin22" src="<%=basePath%>/images/coin222.png" /> <a
				...
				<dd>
					<img class="coin11" src="<%=basePath%>/images/coin111.png" /> <img
						class="coin22" src="<%=basePath%>/images/coin222.png" /> <a
						href="<%=basePath%>ManageAction/showPhyCardInfo.action?page=${1}" target="main" class="cks">体检卡管理</a>
					<img class="icon5" src="<%=basePath%>/images/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="<%=basePath%>/images/coin111.png" /> <img
						class="coin22" src="<%=basePath%>/images/coin222.png" /> <a
						href="<%=basePath%>ManageAction/phyCardManagement.action?page=${1}" target="main" class="cks">用户体检卡管理</a>
					<img class="icon5" src="<%=basePath%>/images/coin21.png" />
				</dd>
			</dl>
