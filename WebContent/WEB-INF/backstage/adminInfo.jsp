...
<body>
	...
	<div class="page">
		...
		<span class="jump"><a
					href="<%=path%>ManageAction/showAdmin.action?page=1&&mangerName=${mangerName}&&phoneNum1=${phoneNum1}&&paramterId1=${paramterId1}&&roleName1=${roleName}&&officeName1=${officeName}">首页</a></span>
			<c:choose>
				<c:when test="${page>1}">
					<span class="jump"><a
