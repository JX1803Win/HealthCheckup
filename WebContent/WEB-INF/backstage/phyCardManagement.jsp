...
<body>
		...
		<form name="selcet"
			...
			<div class="form-group">
				<label for="name" class="m">用户账号：</label> <input type="text"
					...
					placeholder="请输入卡号" value="${userId1}">
			</div>
			<div class="form-group">
	...
	<div class="page">
		<div class="pagelist text-center">
			<span class="jump"><a
				href="<%=path%>ManageAction/phyCardManagement.action?page=1&&userId1=${userId1}&&userName=${userName}&&paramterId=${paramterId}">首页</a></span>
			<c:choose>
				<c:when test="${page>1}">
					<span class="jump"><a
						href="<%=path%>ManageAction/phyCardManagement.action?page=${page-1}&&userId1=${userId1}&&userName=${userName}&&phyCardId1=${phyCardId1}">上一页</a></span>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${page<pageAll}">
					<span class="jump"><a
						href="<%=path%>ManageAction/phyCardManagement.action?page=${page+1}&&userId1=${userId1}&&userName=${userName}&&phyCardId1=${phyCardId1}">下一页</a></span>
				</c:when>
				<c:otherwise>
			...
			<span class="jump"><a
				href="<%=path%>ManageAction/phyCardManagement.action?page=${pageAll}&&userId1=${userId1}&&userName=${userName}&&phyCardId1=${phyCardId1}">末页</a></span>
		</div>
	</div>
	<!-- 模态框（Modal）1 -->
